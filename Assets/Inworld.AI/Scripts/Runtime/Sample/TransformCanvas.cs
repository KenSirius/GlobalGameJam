...
namespace Inworld.Sample
{
    public class TransformCanvas : DemoCanvas
    {
        ...
        void _HandleTextEvent(TextEvent textEvent)
        {
            ...
            {
                InworldAI.Log("Player Uttered the correct words sending trigger " + m_CurrentCharacter.Data.triggers[1]);
        ...
        {
            InworldAI.Log(("Received user defined event " + customEvent.Name));
            if (customEvent.Name == "turnback")
            {
